      ...
      <Container maxWidth='xl'>
        <div className='flex justify-between w-[90%] mx-auto max-[600px]:flex-col '>
          <div className='w-[70%] max-[600px]:w-[100%] '>
            <h1 className='text-[40px]'>Начать проект</h1>
            <Category />
          ...
          <div className='w-[30%] max-[600px]:pt-3 max-[600px]:w-[100%] '>
            <h1 className='text-[40px]'>Офис</h1>
            <p className='mt-[14px]'>
              Душанбе, пр. Рудаки 93/1 (+992) 111-111-789 info@gravity.tj
            </p>
          </div>
        </div>
      </Container>
